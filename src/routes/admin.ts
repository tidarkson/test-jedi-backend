...
const requireAdminRole = async (req: any, res: Response, next: NextFunction): Promise<void> => {
  try {
...
router.get('/orgs/:organizationId/users', requireAdminRole, (req, res, next) =>
  adminController.listUsers(req, res).catch(next),
);

// POST /api/v1/admin/orgs/:organizationId/users/invite
router.post('/orgs/:organizationId/users/invite', requireAdminRole, (req, res, next) =>
  adminController.inviteUser(req, res).catch(next),
);

// POST /api/v1/admin/auth/accept-invitation
router.post('/auth/accept-invitation', (req, res, next) =>
  adminController.acceptInvitation(req, res).catch(next),
);

// PUT /api/v1/admin/orgs/:organizationId/users/:userId/role
router.put('/orgs/:organizationId/users/:userId/role', requireAdminRole, (req, res, next) =>
  adminController.updateUserRole(req, res).catch(next),
);

// DELETE /api/v1/admin/orgs/:organizationId/users/:userId
router.delete('/orgs/:organizationId/users/:userId', requireAdminRole, (req, res, next) =>
  adminController.deactivateUser(req, res).catch(next),
);

// GET /api/v1/admin/orgs/:organizationId/users/:userId/activity
router.get('/orgs/:organizationId/users/:userId/activity', requireAdminRole, (req, res, next) =>
...
router.put('/orgs/:organizationId/projects/:projectId', requireAdminRole, (req, res, next) =>
  adminController.updateProject(req, res).catch(next),
);

// POST /api/v1/admin/orgs/:organizationId/projects/:projectId/archive
router.post('/orgs/:organizationId/projects/:projectId/archive', requireAdminRole, (req, res, next) =>
  adminController.archiveProject(req, res).catch(next),
);

// GET /api/v1/admin/orgs/:organizationId/projects/:projectId/members
router.get('/orgs/:organizationId/projects/:projectId/members', requireAdminRole, (req, res, next) =>
  adminController.getProjectMembers(req, res).catch(next),
);

// POST /api/v1/admin/orgs/:organizationId/projects/:projectId/members
router.post('/orgs/:organizationId/projects/:projectId/members', requireAdminRole, (req, res, next) =>
  adminController.addProjectMember(req, res).catch(next),
);
...
router.get('/orgs/:organizationId/custom-fields', requireAdminRole, (req, res, next) =>
  adminController.listCustomFields(req, res).catch(next),
);

// POST /api/v1/admin/orgs/:organizationId/custom-fields
router.post('/orgs/:organizationId/custom-fields', requireAdminRole, (req, res, next) =>
  adminController.createCustomField(req, res).catch(next),
);

// PUT /api/v1/admin/orgs/:organizationId/custom-fields/:fieldId
router.put('/orgs/:organizationId/custom-fields/:fieldId', requireAdminRole, (req, res, next) =>
  adminController.updateCustomField(req, res).catch(next),
);

// DELETE /api/v1/admin/orgs/:organizationId/custom-fields/:fieldId
router.delete('/orgs/:organizationId/custom-fields/:fieldId', requireAdminRole, (req, res, next) =>
  adminController.deleteCustomField(req, res).catch(next),
);
...
router.get('/orgs/:organizationId/audit-logs', requireAdminRole, (req, res, next) =>
  adminController.getAuditLogs(req, res).catch(next),
);

// GET /api/v1/admin/orgs/:organizationId/audit-logs/export/csv
router.get('/orgs/:organizationId/audit-logs/export/csv', requireAdminRole, (req, res, next) =>
  adminController.exportAuditLogs(req, res).catch(next),
);
...
router.post('/orgs/:organizationId/retention-policies', requireAdminRole, (req, res, next) =>
  adminController.setRetentionPolicy(req, res).catch(next),
);

// GET /api/v1/admin/orgs/:organizationId/retention-policies
router.get('/orgs/:organizationId/retention-policies', requireAdminRole, (req, res, next) =>
  adminController.getRetentionPolicies(req, res).catch(next),
);
