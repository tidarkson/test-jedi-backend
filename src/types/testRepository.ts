...
export interface SuiteDTO {
  ...
  createdAt: Date;
  updatedAt: Date;
  caseCount?: number; // Added to tree response
}
...
export interface UpdateTestCaseInput {
  ...
  tags?: string[];
  customFields?: Record<string, any>;
  steps?: CreateTestStepInput[]; // Complete steps replacement
}
...
export interface BulkOperationItem {
  ...
  newSuiteId?: string; // For move operations
}
...
export interface TestCaseVersionEntry {
  ...
  changedAt: Date;
  changedBy?: string;
  changes: Record<string, any>; // diff of what changed
}
